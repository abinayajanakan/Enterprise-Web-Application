...
1. Copy the HW3 folder and paste it into the webapps folder of tomcat directory.
2. All the servlets are mentioned in the deployment descriptor file web.xml
3. Then start the MySql server. After bothe the database servers are started,
then start the Tomcat server.
4. Run the application by writing localhost/HW3 in the browser.
