...
public class MySqlDataStoreUtilities {
	...
	public static void insertupdated(String prod_name,float price, int qty,int sale,int rebate)
	{
		...
		try
		{
			...
			String insertupdated = "INSERT INTO product_list(prod_name,price,qty,sale,rebate) " + "VALUES (?,?,?,?,?);";
			
			PreparedStatement pst = conn.prepareStatement(insertupdated);
	...
	public static LinkedHashMap<String, ArrayList<Object>> getvalues()
	{
		LinkedHashMap<String, ArrayList<Object>> values = new LinkedHashMap<String, ArrayList<Object>>();
		...
		try
		{
			...
			Statement s = conn.createStatement ();
			s.executeQuery ("SELECT prod_name, price,qty,sale,rebate FROM product_list;");
			ResultSet rs = s.getResultSet();
			...
			while (rs.next ())
			{
				...
				Integer rebate = rs.getInt ("rebate");
				...
				values.put(prod_name, itemArray);
			}
			//System.out.println("Top 5 sold items: "+top5SoldProducts);
			rs.close ();
			s.close ();
	...
	public static LinkedHashMap<String, ArrayList<Object>> Sales()
	{
		LinkedHashMap<String, ArrayList<Object>> Sales = new LinkedHashMap<String, ArrayList<Object>>();
		...
		try
		{
			...
			Statement s = conn.createStatement ();
			s.executeQuery ("SELECT prod_name FROM Sales;");
			ResultSet rs = s.getResultSet();
	...
	public static LinkedHashMap<String, ArrayList<Object>> Rebate()
	{
		...
		try
		{
			...
			Statement s = conn.createStatement ();
			s.executeQuery ("SELECT prod_name FROM manufacturer_rebate;");
			ResultSet rs = s.getResultSet();
			...
			while (rs.next ())
			{
				...
				Rebate.put(prod_name, itemArray);
			}
			//System.out.println("Top 5 sold items: "+top5SoldProducts);
			rs.close ();
			s.close ();
	...
	public static LinkedHashMap<String, ArrayList<Object>> Product_Sold()
	{
		LinkedHashMap<String, ArrayList<Object>> Product_Sold = new LinkedHashMap<String, ArrayList<Object>>();
		...
		try
		{
			...
			Statement s = conn.createStatement ();
			s.executeQuery ("SELECT prod_name,price,item_sold,total_sales FROM product_sold;");
			ResultSet rs = s.getResultSet();
			...
			while (rs.next ())
			{
				String prod_name = rs.getString("prod_name");
				Float price = rs.getFloat ("price");
				Integer item_sold = rs.getInt ("item_sold");
				Integer total_sales = rs.getInt ("total_sales");
				
			   
				ArrayList<Object> itemArray = new ArrayList<Object>();
				itemArray.add(prod_name);
				itemArray.add(price);
				itemArray.add(item_sold);
				itemArray.add(total_sales);
				
				
				Product_Sold.put(prod_name, itemArray);
			}
			//System.out.println("Top 5 sold items: "+top5SoldProducts);
			rs.close ();
			s.close ();
	...
	public static LinkedHashMap<String, ArrayList<Object>> transaction()
	{
		LinkedHashMap<String, ArrayList<Object>> transaction = new LinkedHashMap<String, ArrayList<Object>>();
		...
		try
		{
			...
			Statement s = conn.createStatement ();
			s.executeQuery ("SELECT dates,sales FROM transaction;");
			ResultSet rs = s.getResultSet();
			...
			while (rs.next ())
			{
				...
				transaction.put(dates, itemArray);
			}
			//System.out.println("Top 5 sold items: "+top5SoldProducts);
			rs.close ();
			s.close ();
