...
public class SAXParserForProducts extends DefaultHandler {
    ...
    String smartphonesXmlFileName = "C:/apache-tomcat-7.0.34/webapps/assignment5/WEB-INF/SmartphoneCatalog.xml";
	String tabletsXmlFileName = "C:/apache-tomcat-7.0.34/webapps/assignment5/WEB-INF/TabletCatalog.xml";
	String laptopsXmlFileName = "C:/apache-tomcat-7.0.34/webapps/assignment5/WEB-INF/LaptopCatalog.xml";
	String televisionsXmlFileName = "C:/apache-tomcat-7.0.34/webapps/assignment5/WEB-INF/TelevisionCatalog.xml";
	String accessoriesXmlFileName = "C:/apache-tomcat-7.0.34/webapps/assignment5/WEB-INF/AccessoryCatalog.xml";
    ...
    public ArrayList<Object> loadDataStore() {
		...
		tablets = new HashMap<String,Tabletone>();
		televisions = new HashMap<String,Television>();
		accessories = new HashMap<String,Accessoryone>();
