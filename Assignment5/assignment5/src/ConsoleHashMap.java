...
public class ConsoleHashMap{
	...
	public ConsoleHashMap() {
		...
		if(microsoft.isEmpty()){
			...
			Console xboxone = new Console("APPLE",399.00,"img/sony.jpg","Microsoft","New",10,accessories);
		...
		if(sony.isEmpty()){			
			...
			Console ps4 = new Console("PS4",349.00,"img/sony.jpg","Sony","New",10,accessories);
			sony.put("ps4", ps4);			
		}
		...
		if(lenovo.isEmpty()){
			for(int i = 0; i<=5; i++)
			{
				...
				Console lenovo_yoga = new Console("Lenovo Thinkpad Series"+i,(450.00+i),"lenovolaptop"+i+".jpg","Lenovo","New",50,accessories);
		...
		if(asus.isEmpty()){
			...
			Console asuslaptop = new Console("Asus Laptop",399.00,"img/Lenovo.png","Asus","New",50,accessories);
